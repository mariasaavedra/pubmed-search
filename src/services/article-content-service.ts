...
class ArticleContentService {
   ...
   */
  private normalizeContent(document: Document, original_xml?: string): ContentExtractionResult {
    ...
    try {
      ...
      const mainContent = document.querySelector('#article-details') || 
      ...
      if (mainContent) {
        ...
        // Extract figures
        const figures = document.querySelectorAll('figure, .figure, div[class*="figure"]');
        ...
        // Extract tables
        const tables = document.querySelectorAll('table, .table, div[class*="table"]');
   ...
   */
  private extractSections(mainContent: Element, result: ContentExtractionResult): void {
    // Try section-based extraction first
    const sections = mainContent.querySelectorAll('section, div[role="region"]');
